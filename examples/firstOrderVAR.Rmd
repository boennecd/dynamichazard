...
between time $(t - 1, t]$. The indicators are Poisson distributed conditional on 
knowing the log time at risk, $\vec{o}_t$, covariates, $X_t$ and $Z_t$, and latent states, $\vec{\alpha}_0,\dots,\vec{\alpha}_d$. 
