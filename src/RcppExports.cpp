...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(ddhazard_fit_cpp_prelim(X, tstart, tstop, a_0, Q_0, Q, risk_obj, F_, n_max, eps, verbose, save_all_output, order_, est_Q_0, method, kappa, alpha, beta, model, M_step_formulation));
    return rcpp_result_gen;
END_RCPP
}
