...
brier_func <- function(fit){
  pred <- predict(fit, new_data = sims$res, 
                  tstart = "tstart", tstop = "tstop")
  print(tail(pred$fits, 10))
  c("Brier score" = mean((sims$res$event - pred$fits)^2))
}
...
TODO: Is the predict method correct? 
