...
library(colorspace)
library(dichromat)
cols <- colorschemes$Categorical.12[(1:5)*2]
...
# of times
n_fails <- 0
LRs <- 1.25^(0:(-6)) # Learning rates to try in order to get a fit
...
The mean of the fraction of the coverages for the two methods are printed below:
...
The downwards skew in the bootstrap plot is due to because the learning rate have been decreased for some of the bootstrap estimates in order to estimate the model. An alternative could be to allow for this as done below:
