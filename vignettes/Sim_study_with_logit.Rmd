...
Moreover, you will also find the source code for the vignette in the github package. The note is not meant to be self contained. It is recommend to see (TODO: Insert reference) for an introduction to the models and methods in the `dynamichazard` package
