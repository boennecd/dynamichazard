...
#' @export
ddhazard_fit_cpp_prelim <- function(X, tstart, tstop, a_0, Q_0, Q, risk_obj, F_, n_max = 100L, eps = 0.001, verbose = 0L, save_all_output = FALSE, order_ = 1L, est_Q_0 = TRUE, method = "EKF", kappa = NULL, alpha = NULL, beta = NULL, NR_eps = NULL, LR = NULL, model = "logit", M_step_formulation = "Fahrmier94") {
