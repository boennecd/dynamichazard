...
& = \normalC{\vec{\alpha}_0}{
		...
		\optor{\mat{S}_{\vec{\theta}}}{\vec{\alpha}_1}
	}
	\optorC{\Prob_{\vec{\theta}}}{\vec{\alpha}_1}{\vec{y}_{1:d}} \\
%
& \approx \sum_{i=1}^{N_s}
	\normalC{\vec{\alpha}_0}{
		...
		\optor{\mat{S}_{\vec{\theta}}}{\particS{\vec{\alpha}}{1}{i}}
	}
...
\begin{equation}\begin{split}
	\optor{\mat{S}_{\vec{\theta}}}{\vec{\alpha}}^{-1} &= 
		\mat{Q}_0^{-1} + \mat{F}^{-1}\mat{Q}^{-1}\Lparen{\mat{F}^{-1}}^\top \\ 
%
	\optor{\vec{m}_{\vec{\theta}}}{\vec{\alpha}} &= 
		\optor{\mat{S}_{\vec{\theta}}}{\vec{\alpha}}
		\Lparen{\mat{Q}_0^{-1}\vec{a}_0 + \mat{F}^{-1}\mat{Q}^{-1}\vec{a}_0}
\end{split}\end{equation}%
%
Thus, we end with:
...
\vec{T}_1^{(\vec{\theta})} \approx  
	\sum_{i = 1}^{N_s} \hspace{15pt} & \hspace{-15pt} \left(
		\particS{w}{1}{i}\particS{\vec{\alpha}}{1}{i}\Lparen{\particS{\vec{\alpha}}{1}{i}}^\top 
		+ \mat{F}\mat{Q}_0\mat{F}^\top \right. \\
%
	& \left. - \particS{w}{1}{i}\mat{F}\optor{\vec{m}_{\vec{\theta}}}{\particS{\vec{\alpha}}{1}{i}}
		\Lparen{\particS{\vec{\alpha}}{1}{i}}^\top
	- \particS{w}{1}{i}\particS{\vec{\alpha}}{1}{i}
		\optor{\vec{m}_{\vec{\theta}}}{\particS{\vec{\alpha}}{1}{i}}^\top\mat{F}^\top \right)
\end{split}\end{equation}
