...
# save_to_test(result_exp, "ddhazard_exp_sim_data")

test_that("Gets preivous results with combined exp model",
          expect_equal(result_exp, read_to_test("ddhazard_exp_sim_data"), tolerance = 1e-04))
