...
test_that("UKF with fixed effects works", {
  ...
  expect_equal(c(fit$state_vecs),
               c( 0.07508886162538082, 0.07508595042706501, 0.21411400995749660, 0.61363196236453299, 1.03251281565802833,  1.08185846742959102, 0.98567789739844791, 1.23249684941191595, 1.61827284236540381, 1.71833499330534711,  1.73880187098329686, -0.16657444964181656, -0.16656086809137624, -0.50067859177929130, -0.71161568316835488, -0.99831295006964460, -1.04784598617818969, -1.30101708269051430, -0.87332295972761576, -0.61897202504999660, -0.12357107087011182, 0.55355345839632508 ))

  expect_equal(c(fit$state_vars),
               c(0.244208650079373868, 0.008884942508553925, 0.008884942510402897, 0.357549229133814706, 0.085516988503419392, 0.001885300012020397, 0.001885300013951995, 0.091762274278655631, 0.083876335187970358, 0.001920409905471544, 0.001920409907403144, 0.101238109606279089, 0.084189038805600719, 0.001737546659137515, 0.001737546661069113, 0.103077863685580029, 0.084239253610438991, 0.001541794839363721, 0.001541794841295319, 0.103958367057004536, 0.082948105374406972, 0.002715215729121990, 0.002715215731053588, 0.101959485159928670, 0.084127828515104350, 0.003041044420586341, 0.003041044422517940, 0.103954557844021106, 0.086180150034429109, 0.002449105378539972, 0.002449105380471573, 0.104982737485483452, 0.089459993614943084, 0.002874725587622421, 0.002874725589554022, 0.108826315483573549, 0.095239999324271796, 0.003822516644929459, 0.003822516646861056, 0.114294184796325818, 0.126697780450180764, 0.003436726584075182, 0.003436726586006779, 0.151392093513917969 ))

  expect_equal(c(fit$lag_one_cov),
               c(NULL ))

  expect_equal(unname(c(fit$fixed_effects)),
               c(-3.7156282568243522, -0.4061270262182999  ))

  expect_equal(c(fit$n_iter),
               c(12 ))

  expect_equal(c(fit$Q),
               c(0.164487069746425352, 0.007736054319158201, 0.007736054319158201, 0.279787964837775127 ))
